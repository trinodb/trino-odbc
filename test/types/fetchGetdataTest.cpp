...
class FetchGetDataTest : public SQLDriverConnectFixture {
  protected:
    template <Numeric T>
    void executeAndValidateQuery(const std::string& query,
      ...
      T result            = 0;
      SQLLEN indicator    = 0;
      SQLLEN bufferLength = -1; // This is ignored for fixed-length data.
...
TEST_F(FetchGetDataTest, SelectGUID) {
...
TEST_F(FetchGetDataTest, SelectPositiveDecimal) {
...
TEST_F(FetchGetDataTest, SelectNegativeDecimal) {
...
TEST_F(FetchGetDataTest, SelectIntegralDecimal) {
...
TEST_F(FetchGetDataTest, SelectDecimalVarchar) {
...
TEST_F(FetchGetDataTest, SelectDate) {
...
TEST_F(FetchGetDataTest, SelectTime) {
  SQLUSMALLINT hour   = 4;
...
TEST_F(FetchGetDataTest, SelectTimestamp) {
  SQLSMALLINT year     = 2024;
  SQLUSMALLINT month   = 9;
  SQLUSMALLINT day     = 13;
  SQLUSMALLINT hour    = 4;
...
TEST_F(FetchGetDataTest, SelectTimestampWithTimeZone) {
